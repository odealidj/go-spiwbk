...
type handler struct {
	service service.SpiAngService
}

var err error

func NewHandler(f *factory.Factory) *handler {
	service := service.NewSpiAngService(f)
...
func (h *handler) Save(c echo.Context) error {
	...
	payload := new(dto.SpiAngSaveRequest)
...
func (h *handler) Update(c echo.Context) error {
	...
	payload := new(dto.SpiAngUpdateRequest)
	if err = c.Bind(payload); err != nil {
		return res.ErrorBuilder(&res.ErrorConstant.BadRequest, err).Send(c)
	}
	if err = c.Validate(payload); err != nil {
...
func (h *handler) Delete(c echo.Context) error {
	...
	payload := new(dto.SpiAngDeleteRequest)
	if err = c.Bind(payload); err != nil {
		return res.ErrorBuilder(&res.ErrorConstant.BadRequest, err).Send(c)
	}
	if err = c.Validate(payload); err != nil {
...
func (h *handler) Get(c echo.Context) error {
	...
	payload := new(dto.SpiAngGetRequest)
	if err := c.Bind(payload); err != nil {
		return res.ErrorBuilder(&res.ErrorConstant.BadRequest, err).Send(c)
	}
	if err = c.Validate(payload); err != nil {
...
func (h *handler) GetByID(c echo.Context) error {
	...
	payload := new(dto.SpiAngGetByIDRequest)
	if err = c.Bind(payload); err != nil {
		return res.ErrorBuilder(&res.ErrorConstant.BadRequest, err).Send(c)
	}
	if err = c.Validate(payload); err != nil {
