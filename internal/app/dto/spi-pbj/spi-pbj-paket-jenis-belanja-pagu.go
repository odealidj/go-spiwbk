...
//Save
type SpiPbjPaketJenisBelanjaPaguSaveRequest struct {
...
//Get
type SpiPbjPaketJenisBelanjaPaguGetRequest struct {
	abstraction.Pagination
	spi_pbj.SpiPbjPaketJenisBelanjaPaguFilter
}

type SpiPbjPaketJenisBelanjaPaguGetResponse struct {
	Row                 int             `json:"row"`
...
type SpiPbjPaketJenisBelanjaPaguGetInfoResponse struct {
	Datas          *[]SpiPbjPaketJenisBelanjaPaguGetReformatResponse
	PaginationInfo *abstraction.PaginationInfo
}

type SpiPbjPaketJenisBelanjaPaguResponse struct {
	abstraction.ID
	spi_pbj.SpiPbjPaketJenisBelanjaPaguEntity
	SatkerID int `json:"satkerID"`
	ThnAngID int `json:"thnAngID"`
}
