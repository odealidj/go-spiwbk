...
type JenisBelanjaPagu interface {
	...
	Find(*abstraction.Context, *spi_pbj.JenisBelanjaPaguFilter, *abstraction.Pagination) ([]spi_pbj.JenisBelanjaPagu, *abstraction.PaginationInfo, error)
...
func (r *jenisBelanjaPagu) Find(ctx *abstraction.Context, m *spi_pbj.JenisBelanjaPaguFilter, p *abstraction.Pagination) ([]spi_pbj.JenisBelanjaPagu, *abstraction.PaginationInfo, error) {
	conn := r.CheckTrx(ctx)

	var err error
	var count int64
	var result []spi_pbj.JenisBelanjaPagu
