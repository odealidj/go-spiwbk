...
type SpiPbjPaketJenisBelanjaPagu interface {
	Upsert(*abstraction.Context, *spi_pbj.SpiPbjPaketJenisBelanjaPagu) (*spi_pbj.SpiPbjPaketJenisBelanjaPagu, error)
	...
	FindspiPbjPaketJenisBelanjaPaguByThnAngIDAndSatkerID(*abstraction.Context,
		*spi_pbj.SpiPbjPaketJenisBelanjaPaguFilter, *abstraction.Pagination) ([]spi_pbj2.SpiPbjPaketJenisBelanjaPaguGetResponse, *abstraction.PaginationInfo, error)
...
func (r *spiPbjPaketJenisBelanjaPagu) Create(ctx *abstraction.Context, m *spi_pbj.SpiPbjPaketJenisBelanjaPagu) (*spi_pbj.SpiPbjPaketJenisBelanjaPagu, error) {
	conn := r.CheckTrx(ctx)
...
func (r *spiPbjPaketJenisBelanjaPagu) Upsert(ctx *abstraction.Context, m *spi_pbj.SpiPbjPaketJenisBelanjaPagu) (*spi_pbj.SpiPbjPaketJenisBelanjaPagu, error) {
	conn := r.CheckTrx(ctx)
...
func (r *spiPbjPaketJenisBelanjaPagu) FindspiPbjPaketJenisBelanjaPaguByThnAngIDAndSatkerID(ctx *abstraction.Context,
	m *spi_pbj.SpiPbjPaketJenisBelanjaPaguFilter, p *abstraction.Pagination) ([]spi_pbj2.SpiPbjPaketJenisBelanjaPaguGetResponse, *abstraction.PaginationInfo, error) {
	conn := r.CheckTrx(ctx)

	var err error
	var count int64
	var result []spi_pbj2.SpiPbjPaketJenisBelanjaPaguGetResponse
