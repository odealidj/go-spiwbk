...
type JenisRekapitulasi interface {
	...
	Find(*abstraction.Context, *spi_pbj.JenisRekapitulasiFilter, *abstraction.Pagination) ([]spi_pbj.JenisRekapitulasi, *abstraction.PaginationInfo, error)
...
func (r *jenisRekapitulasi) Find(ctx *abstraction.Context, m *spi_pbj.JenisRekapitulasiFilter, p *abstraction.Pagination) ([]spi_pbj.JenisRekapitulasi,
	*abstraction.PaginationInfo, error) {
	conn := r.CheckTrx(ctx)

	var err error
	var count int64
	var result []spi_pbj.JenisRekapitulasi
