...
type SpiPbjPaket interface {
	Create(*abstraction.Context, *spi_pbj.SpiPbjPaket) (*spi_pbj.SpiPbjPaket, error)
	Upsert(*abstraction.Context, *spi_pbj.SpiPbjPaket) (*spi_pbj.SpiPbjPaket, error)
	...
	FindSpiPbjPaketByID(*abstraction.Context, *spi_pbj.SpiPbjPaketFilter, *abstraction.Pagination) ([]spi_pbj2.SpiPbjPaketGetResponse, *abstraction.PaginationInfo, error)
...
func (r *spiPbjPaket) Create(ctx *abstraction.Context, m *spi_pbj.SpiPbjPaket) (*spi_pbj.SpiPbjPaket, error) {
	conn := r.CheckTrx(ctx)
...
func (r *spiPbjPaket) Upsert(ctx *abstraction.Context, m *spi_pbj.SpiPbjPaket) (*spi_pbj.SpiPbjPaket, error) {
	conn := r.CheckTrx(ctx)
...
func (r *spiPbjPaket) FindSpiPbjPaketByID(ctx *abstraction.Context,
	m *spi_pbj.SpiPbjPaketFilter, p *abstraction.Pagination) ([]spi_pbj2.SpiPbjPaketGetResponse,
	*abstraction.PaginationInfo, error) {
	conn := r.CheckTrx(ctx)

	var err error
	var count int64
	var result []spi_pbj2.SpiPbjPaketGetResponse
