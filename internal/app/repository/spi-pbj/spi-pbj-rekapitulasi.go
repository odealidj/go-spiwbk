...
type SpiPbjRekapitulasi interface {
	Create(*abstraction.Context, *spi_pbj.SpiPbjRekapitulasi) (*spi_pbj.SpiPbjRekapitulasi, error)
	Upsert(*abstraction.Context, *spi_pbj.SpiPbjRekapitulasi) (*spi_pbj.SpiPbjRekapitulasi, error)
	...
	FindSpiPbjRekapitulasiByID(*abstraction.Context, *spi_pbj.SpiPbjRekapitulasiFilter, *abstraction.Pagination) ([]spi_pbj2.SpiPbjRekapitulasiGetResponse, *abstraction.PaginationInfo, error)
...
func (r *spiPbjRekapitulasi) Create(ctx *abstraction.Context, m *spi_pbj.SpiPbjRekapitulasi) (*spi_pbj.SpiPbjRekapitulasi, error) {
	conn := r.CheckTrx(ctx)
...
func (r *spiPbjRekapitulasi) Upsert(ctx *abstraction.Context, m *spi_pbj.SpiPbjRekapitulasi) (*spi_pbj.SpiPbjRekapitulasi, error) {
	conn := r.CheckTrx(ctx)
...
func (r *spiPbjRekapitulasi) FindSpiPbjRekapitulasiByID(ctx *abstraction.Context,
	m *spi_pbj.SpiPbjRekapitulasiFilter, p *abstraction.Pagination) ([]spi_pbj2.SpiPbjRekapitulasiGetResponse,
	*abstraction.PaginationInfo, error) {
	conn := r.CheckTrx(ctx)

	var err error
	var count int64
	var result []spi_pbj2.SpiPbjRekapitulasiGetResponse
