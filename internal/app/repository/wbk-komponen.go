...
type WbkKomponen interface {
	...
	Find(*abstraction.Context, *model.WbkKomponenFilter, *abstraction.Pagination) ([]dto.WbkKomponenGetResponse, *abstraction.PaginationInfo, error)
...
func (r *wbkKomponen) Find(ctx *abstraction.Context,
	m *model.WbkKomponenFilter, p *abstraction.Pagination) ([]dto.WbkKomponenGetResponse,
	*abstraction.PaginationInfo, error) {
	conn := r.CheckTrx(ctx)

	var err error
	var count int64
	var result []dto.WbkKomponenGetResponse
