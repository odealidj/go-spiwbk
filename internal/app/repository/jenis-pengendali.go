...
type JenisPengendali interface {
	...
	Find(*abstraction.Context, *model.JenisPengendaliFilter, *abstraction.Pagination) ([]model.JenisPengendali, *abstraction.PaginationInfo, error)
...
func NewJenisPengendali(db *gorm.DB) *jenisPengendali {
...
func (r *jenisPengendali) Find(ctx *abstraction.Context, m *model.JenisPengendaliFilter, p *abstraction.Pagination) ([]model.JenisPengendali, *abstraction.PaginationInfo, error) {
	conn := r.CheckTrx(ctx)
...
func (r *jenisPengendali) checkTrx(ctx *abstraction.Context) *gorm.DB {
	if ctx.Trx != nil {
		return ctx.Trx.Db
	}
	return r.Db
