...
type GroupPackageValue interface {
	...
	FindExistSpiPbjPaket(*abstraction.Context, *model.GroupPackageValueFilter, *abstraction.Pagination) ([]model.GroupPackageValue, *abstraction.PaginationInfo, error)
...
func (r *groupPackageValue) FindExistSpiPbjPaket(ctx *abstraction.Context, m *model.GroupPackageValueFilter, p *abstraction.Pagination) ([]model.GroupPackageValue, *abstraction.PaginationInfo, error) {
	conn := r.CheckTrx(ctx)
