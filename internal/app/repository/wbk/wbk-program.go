...
type WbkProgram interface {
	Create(*abstraction.Context, *wbk.WbkProgram) (*wbk.WbkProgram, error)
	...
	Upsert(*abstraction.Context, *wbk.WbkProgram) (*wbk.WbkProgram, error)
	Find(*abstraction.Context, *wbk.WbkProgramFilter, *abstraction.Pagination) ([]wbk2.WbkProgramGetResponse, *abstraction.PaginationInfo, error)
	FindByThnAngIDAndSatkerID(*abstraction.Context, *wbk.WbkProgramFilter, *abstraction.Pagination) ([]wbk2.WbkProgramNilaiGetByThnAngIDAndSatkerIDResponse, *abstraction.PaginationInfo, error)
...
func (r *wbkProgram) Create(ctx *abstraction.Context, m *wbk.WbkProgram) (*wbk.WbkProgram, error) {
	conn := r.CheckTrx(ctx)
...
func (r *wbkProgram) Upsert(ctx *abstraction.Context, m *wbk.WbkProgram) (*wbk.WbkProgram, error) {
	conn := r.CheckTrx(ctx)
...
func (r *wbkProgram) Find(ctx *abstraction.Context,
	m *wbk.WbkProgramFilter, p *abstraction.Pagination) ([]wbk2.WbkProgramGetResponse,
	*abstraction.PaginationInfo, error) {
	conn := r.CheckTrx(ctx)

	var err error
	var count int64
	var result []wbk2.WbkProgramGetResponse
...
func (r *wbkProgram) FindByThnAngIDAndSatkerID(ctx *abstraction.Context,
	m *wbk.WbkProgramFilter, p *abstraction.Pagination) ([]wbk2.WbkProgramNilaiGetByThnAngIDAndSatkerIDResponse,
	*abstraction.PaginationInfo, error) {
	conn := r.CheckTrx(ctx)

	var err error
	var count int64
	var result []wbk2.WbkProgramNilaiGetByThnAngIDAndSatkerIDResponse
	var info abstraction.PaginationInfo
