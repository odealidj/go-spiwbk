...
type WbkSubProgramRanker interface {
	Create(*abstraction.Context, *wbk.WbkSubProgramRanker) (*wbk.WbkSubProgramRanker, error)
	Upsert(*abstraction.Context, *wbk.WbkSubProgramRanker) (*wbk.WbkSubProgramRanker, error)
	...
	Find(*abstraction.Context, *wbk.WbkSubProgramRankerFilter, *abstraction.Pagination) ([]wbk2.WbkSubProgramRankerGetResponse, *abstraction.PaginationInfo, error)
...
func (r *wbkSubProgramRanker) Create(ctx *abstraction.Context, m *wbk.WbkSubProgramRanker) (*wbk.WbkSubProgramRanker, error) {
	conn := r.CheckTrx(ctx)
...
func (r *wbkSubProgramRanker) Upsert(ctx *abstraction.Context, m *wbk.WbkSubProgramRanker) (*wbk.WbkSubProgramRanker, error) {
	conn := r.CheckTrx(ctx)
...
func (r *wbkSubProgramRanker) Find(ctx *abstraction.Context,
	m *wbk.WbkSubProgramRankerFilter, p *abstraction.Pagination) ([]wbk2.WbkSubProgramRankerGetResponse,
	*abstraction.PaginationInfo, error) {
	conn := r.CheckTrx(ctx)

	var err error
	var count int64
	var result []wbk2.WbkSubProgramRankerGetResponse
