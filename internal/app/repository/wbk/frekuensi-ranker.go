...
type FrekuensiRanker interface {
	Create(*abstraction.Context, *wbk.FrekuensiRanker) (*wbk.FrekuensiRanker, error)
	Upsert(*abstraction.Context, *wbk.FrekuensiRanker) (*wbk.FrekuensiRanker, error)
	...
	Find(*abstraction.Context, *wbk.FrekuensiRankerFilter, *abstraction.Pagination) ([]wbk2.FrekuensiRankerGetResponse, *abstraction.PaginationInfo, error)
...
func (r *frekuensiRanker) Create(ctx *abstraction.Context, m *wbk.FrekuensiRanker) (*wbk.FrekuensiRanker, error) {
	conn := r.CheckTrx(ctx)
...
func (r *frekuensiRanker) Upsert(ctx *abstraction.Context, m *wbk.FrekuensiRanker) (*wbk.FrekuensiRanker, error) {
	conn := r.CheckTrx(ctx)
...
func (r *frekuensiRanker) Find(ctx *abstraction.Context,
	m *wbk.FrekuensiRankerFilter, p *abstraction.Pagination) ([]wbk2.FrekuensiRankerGetResponse,
	*abstraction.PaginationInfo, error) {
	conn := r.CheckTrx(ctx)

	var err error
	var count int64
	var result []wbk2.FrekuensiRankerGetResponse
