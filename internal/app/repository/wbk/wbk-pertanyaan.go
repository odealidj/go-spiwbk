...
type WbkPertanyaan interface {
	Find(*abstraction.Context, *wbk.WbkPertanyaanFilter, *abstraction.Pagination) ([]wbk2.WbkPertanyaanGetResponse, *abstraction.PaginationInfo, error)
	Upsert(*abstraction.Context, *wbk.WbkPertanyaan) (*wbk.WbkPertanyaan, error)
...
func (r *wbkPertanyaan) Upsert(ctx *abstraction.Context, m *wbk.WbkPertanyaan) (*wbk.WbkPertanyaan, error) {
	conn := r.CheckTrx(ctx)
...
func (r *wbkPertanyaan) Find(ctx *abstraction.Context,
	m *wbk.WbkPertanyaanFilter, p *abstraction.Pagination) ([]wbk2.WbkPertanyaanGetResponse,
	*abstraction.PaginationInfo, error) {
	conn := r.CheckTrx(ctx)

	var err error
	var count int64
	var result []wbk2.WbkPertanyaanGetResponse
