...
type WbkDocUploadSubProgramRanker interface {
	Create(*abstraction.Context, *wbk.WbkDocUploadSubProgramRanker) (*wbk.WbkDocUploadSubProgramRanker, error)
	Upsert(*abstraction.Context, *wbk.WbkDocUploadSubProgramRanker) (*wbk.WbkDocUploadSubProgramRanker, error)
	...
	Find(*abstraction.Context, *wbk.WbkDocUploadSubProgramRankerFilter, *abstraction.Pagination) ([]wbk2.WbkDocUploadSubProgramRankerGetResponse, *abstraction.PaginationInfo, error)
...
func NewWbkDocUploadSubProgramRanker(db *gorm.DB) *wbkDocUploadSubProgramRanker {
	return &wbkDocUploadSubProgramRanker{
		abstraction.Repository{
			Db: db,
		},
	}
...
func (r *wbkDocUploadSubProgramRanker) Create(ctx *abstraction.Context, m *wbk.WbkDocUploadSubProgramRanker) (*wbk.WbkDocUploadSubProgramRanker, error) {
	conn := r.CheckTrx(ctx)

	err := conn.FirstOrCreate(&m, map[string]interface{}{"wbk_sub_program_ranker_bulan_id": m.WbkSubProgramRankerBulanID,
...
func (r *wbkDocUploadSubProgramRanker) Upsert(ctx *abstraction.Context, m *wbk.WbkDocUploadSubProgramRanker) (*wbk.WbkDocUploadSubProgramRanker, error) {
	conn := r.CheckTrx(ctx)

	err := conn.Clauses(clause.OnConflict{
		Columns: []clause.Column{{Name: "id"}},
		DoUpdates: clause.AssignmentColumns([]string{"wbk_sub_program_ranker_bulan_id",
			"path", "ket"}),
		//UpdateAll: true,
...
func (r *wbkDocUploadSubProgramRanker) Find(ctx *abstraction.Context,
	m *wbk.WbkDocUploadSubProgramRankerFilter, p *abstraction.Pagination) ([]wbk2.WbkDocUploadSubProgramRankerGetResponse,
	*abstraction.PaginationInfo, error) {
	conn := r.CheckTrx(ctx)

	var err error
	var count int64
	var result []wbk2.WbkDocUploadSubProgramRankerGetResponse
...
func (r *wbkDocUploadSubProgramRanker) checkTrx(ctx *abstraction.Context) *gorm.DB {
	if ctx.Trx != nil {
		return ctx.Trx.Db
	}
	return r.Db
